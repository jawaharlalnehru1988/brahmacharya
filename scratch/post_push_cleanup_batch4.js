...
async function cleanUp() {
    try {
        ...
        const tempFiles = [
            'love-story-narratives-illusion-ta.json',
            'attention-fragmentation-brahmacharya-ta.json',
            'continual-hearing-sravanam-ta.json',
            'seeing-opposite-gender-properly-ta.json',
            'gradual-rebuilding-post-fall-ta.json'
        ];
