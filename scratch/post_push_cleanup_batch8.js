...
async function cleanUp() {
    try {
        ...
        const tempFiles = [
            'western-pop-lyrics-manipulation-ta.json',
            'social-drinking-pressure-workplace-ta.json',
            'fast-food-overstimulation-rajas-ta.json',
            'night-time-phone-usage-tamas-ta.json',
            'balanced-austerity-yukta-vairagya-ta.json'
        ];
