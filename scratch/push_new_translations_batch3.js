...
async function pushNewTranslations() {
    const articles = [
        'avoiding-complacency-spiritual-danger-ta.json',
        'internal-satisfaction-atmarama-ta.json',
        'avoiding-despair-after-fall-ta.json',
        'lessons-from-ajamila-digital-warning-ta.json',
        'regulated-eating-timings-ta.json'
    ];
