                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16">
                    <div className="col-span-1 lg:col-span-1">
                        <div className="flex items-center gap-3 mb-8">
                            ...
                            <span className="text-xl font-bold text-spiritual-blue font-serif-title uppercase tracking-wider">{t.logo_subtitle}</span>
                        </div>
                    ...
                    <div>
                        <h6 className="font-bold text-spiritual-blue mb-8 uppercase tracking-widest text-xs">{t.footer_link_pathways}</h6>
                    ...
                    <div>
                        <h6 className="font-bold text-spiritual-blue mb-8 uppercase tracking-widest text-xs">{t.footer_link_community}</h6>
                        <ul className="space-y-4 text-sm text-slate-600 font-medium">
                    ...
                    <div>
                        <h6 className="font-bold text-spiritual-blue mb-8 uppercase tracking-widest text-xs">{t.footer_newsletter_title}</h6>
                        <p className="text-sm text-slate-600 mb-6">{t.footer_newsletter_desc}</p>
                        <form className="flex flex-col gap-3">
                            ...
                            <button className="rounded-xl bg-spiritual-blue px-6 py-3 text-white font-bold hover:bg-slate-800 transition-all uppercase tracking-widest text-xs flex items-center justify-center gap-2" type="submit">
                                {t.footer_btn_subscribe} <span className="material-symbols-outlined text-sm">mail</span>
                            </button>
                        </form>
                    </div>
                </div>
                <div className="mt-16 pt-8 border-t border-gold/10 flex flex-col sm:flex-row justify-between items-center gap-6">
                    <p className="text-[10px] text-slate-500 font-bold uppercase tracking-widest">{t.footer_copyright}</p>
                    <div className="flex gap-8">
                        <a className="text-[10px] font-bold uppercase tracking-widest text-slate-500 hover:text-saffron" href="#">{t.footer_privacy}</a>
                        <a className="text-[10px] font-bold uppercase tracking-widest text-slate-500 hover:text-saffron" href="#">{t.footer_terms}</a>
                    </div>
                </div>
            </div>
        </footer>
